...
class _KatalogPageState extends State<KatalogPage> {
  ...
  // final KatalogBloc paginationBloc = KatalogBloc();
  // int page = 1;

  @override
  void initState() {
    super.initState();
    // katalogBloc.add(FetchNextPage(page, 1));

    // _scrollController.addListener(() {
    //   if (_scrollController.position.pixels ==
    //           _scrollController.position.maxScrollExtent &&
    //       !katalogBloc.state.hasReachedMax) {
    //     page++;
    //     katalogBloc.add(
    //       FetchNextPage(
      ...
      katalogBloc = KatalogBloc()
        ..add(GetKatalogEvent(
            selectedItem.isEmpty
                ...
                : widget
                    .model.item![widget.index].childs![selectedSubCategory].id!,
            10));
...
//     if (widget.model.item![widget.index].childs!.isNotEmpty) {
//       katalogBloc = KatalogBloc()
//         ..add(GetKatalogEvent(selectedItem.isEmpty
//             ? widget.model.item![widget.index].childs![0].id!
//             : widget
//                 .model.item![widget.index].childs![selectedSubCategory].id!));
//       for (var e in widget.model.item![widget.index].childs!) {
...
//                                     if (subCategories[i] == selectedItem) {
//                                       selectedSubCategory = i;
//                                       katalogBloc.add(GetKatalogEvent(widget
//                                           .model
//                                           .item![widget.index]
//                                           .childs![selectedSubCategory]
//                                           .id!));
//                                       setState(() {});
//                                     }
//                                   }
