...
part of 'post_user_add_card_confirm_response_model.dart';
...
PostUserAddCardConfirmResponseModel
    _$PostUserAddCardConfirmResponseModelFromJson(Map<String, dynamic> json) =>
        PostUserAddCardConfirmResponseModel(
...
Map<String, dynamic> _$PostUserAddCardConfirmResponseModelToJson(
        PostUserAddCardConfirmResponseModel instance) =>
    <String, dynamic>{
